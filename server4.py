...
def handle_request():
    ...
    result = preprocess_image(imgBase64)
...
def test_image(img):
    ...
    # return digit
    predict_value = np.concatenate(predict_value)
    predict_value = np.around(predict_value, decimals = 3)
    print(predict_value)
